...
console.log(myHeros);
myHeros.pop() // array me jo bhi last index ki value he use remove karne ke lie.
console.log(myHeros); 
myHeros.unshift("HawkEye") // its add new value on 0th index existing values shifted by +1
console.log(myHeros); 
...
console.log("org array after slice :-",myArr1); //slice origanal array ko cahnge nahi karna
console.log(myArr2);
console.log("C",myArr2);
const myn2 = myArr2.splice(1,3) //ye operation index 1 2 3 ka element hta dega
console.log("splice",myn2);
console.log("org array after slice :-",myArr2); //splice origanal array ko change kar deta he